...
const AboutUsPage = () => {
  return (
    <div>
      <div>
        <h1>
          Welcome to Harmony Haven: Your Companion in Overcoming Anxiety and
          Depression
        </h1>
        <p>
          At Harmony Haven, we understand the challenges that come with managing
          anxiety and depression. Our mission is to provide you with a
          supportive and empowering platform that helps you regain control over
          your mental well-being. We believe that everyone deserves a chance to
          lead a fulfilling life, free from the grips of anxiety and depression.
        </p>
      </div>
      <div>
        <h1>Our Values</h1>
      ...
      <div>
        ...
        <p>
          ...
          anxiety and depression. We understand the nuances of these challenges
          and have tailored our tools to provide the right support.
        </p>
      </div>
      <div>
      ...
      <div>
        ...
        <p>
          ...
          have found a sense of peace and control that I never thought possible.
          - Sarah R.
        </p>
      </div>
      <div>
        ...
        <p>
          ...
          state-of-the-art security measures to protect your data, and we never
          share your personal information without your consent. You can focus on
          your well-being without worrying about your data.
        </p>
      </div>
      <div>
        <h1>An App for Everyone</h1>
        <p>
          We are committed to inclusivity. Our app is designed to be accessible
          to all users, including those with disabilities. We are continuously
          working to create an environment where everyone feels welcome and
          supported.
        </p>
      </div>
      <div>
        ...
        <p>
          LCalmMind incorporates evidence-based techniques rooted in psychology
          and mental health research. We are dedicated to providing you with
          tools that have been proven effective in managing anxiety and
          depression.
        </p>
      </div>
      <div>
        ...
        <p>
          Connect with others on the same journey. Our community spaces provide
          a safe haven for sharing, learning, and growing together.
        </p>
      </div>
    </div>
  );
